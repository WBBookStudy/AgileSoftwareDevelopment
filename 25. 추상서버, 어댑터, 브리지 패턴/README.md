...
이에 대해 각자 자기가 가장 좋아하는 해결방법을 제시하기로 했는데, 어떤 사람은 그냥 스위치와 전구 객체만 있는 단순한 접근방법을 사용했고,  
어떤 사람은 스위치와 전구를 포함하는 램프 객체도 있어야 한다고 생각했다. 일부는 전기도 객체로 만들고, 전기 코드 객체를 제안하는 사람도 있었다.  
